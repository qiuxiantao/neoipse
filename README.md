...
| 🔄 **按权重选择** | fallback 模式按固定权重顺序依次尝试数据源 |
...
| `DataSourceManager` | 数据源管理，提供按固定权重排序的数据源列表 |
...
### v2.0.5 (2026-04-26)
- 🔧 移除健康检查功能和智能切换机制，简化插件更轻量
- 🔧 移除连续失败检测、自动恢复、动态权重等复杂功能，简化为按固定权重顺序依次尝试数据源
- 🐛 修复多个配置和异常处理问题
- 📚 更新文档说明
